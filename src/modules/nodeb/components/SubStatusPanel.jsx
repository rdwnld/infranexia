  ...
  return (
    <div className="bg-slate-900/80 border border-slate-800 rounded-xl p-5 shadow-lg flex flex-col">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-slate-100 font-semibold text-lg">Progres Lapangan Ranking</h2>
          <p className="text-xs text-slate-400">Daftar tahapan progres paling banyak (klik item untuk filter)</p>
        </div>
